...
if (count($node->field_screenshots) != 0) {
...
<div id="node-<?php print $node->nid; ?>" class="node clear-block node-type-ls_tools-teaser <?php print 
 ...
 <div class="tool-teaser-footer">
	<div class="tool-type"><div class="tool-type-icon"></div>OpenSocial</div>
              		...
              		<a id="tool-select-button" href="#">
              			<?php print	("Select") ?> 
    						...
    						<div class="field-url field">
    							<label class="field-label"><?php print t("Source URL:") ?></label>
                  <?php print theme('lstool_opensocial_source', $node);?>
                </div>
    						<div class="field-embed-code field">
    							<label class="field-label"><?php print t("Embed Code:") ?></label>
                  <?php print theme('lstool_opensocial_embed_code', $node);?>              
    						</div>
    						<div class="field-google field">
                  <?php print theme('lstool_opensocial_add_to_container',$node, $vars['node']->teaser);?>
    						</div>
